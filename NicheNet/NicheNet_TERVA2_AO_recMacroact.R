...
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Cd8+ Ccl5+ Teffs", "Cd4+ Foxp3+ Tregs", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Vascular smooth muscle cells", "B cells", "Conventional Dendritic cells 2")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(DC2_specific_ligands, ILC_specific_ligands, Cd4T_specific_ligands, Cd8T_specific_ligands, Mono_specific_ligands, IntMono_specific_ligands, Macroact_specific_ligands, Macro_specific_ligands, general_ligands))
...
ligand_order = c(Mono_specific_ligands, IntMono_specific_ligands, Macroact_specific_ligands, Macro_specific_ligands, Cd4T_specific_ligands, Cd8T_specific_ligands, ILC_specific_ligands, DC2_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
...
gaps = c(
  ...
  #rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "IntMono-specific") %>% distinct(ligand) %>% nrow() -1)),
  #width_different_cell,
  ...
  #width_different_cell,
  #rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "Macroact-specific") %>% distinct(ligand) %>% nrow() -1)),
  #width_different_cell,
