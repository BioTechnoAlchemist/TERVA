...
## sender
sender_celltypes = c("Ccl11+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Mfap4+ Fibroblasts", "Folr2+ Lyve1+ M2 Macrophages", "Ccl4+ Cxcl2+ Ccl3+ Inflammatory Macrophages", 
...
ligand_order = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Folr2Lyve1Macro_specific_ligands, Infl_Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, EC_specific_ligands, Treg_specific_ligands, VSMC_specific_ligands, Intermono_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
