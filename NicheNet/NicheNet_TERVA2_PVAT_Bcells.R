...
## sender
sender_celltypes = c("Cd248+ Pi16+ Fibroblasts", "Mfap4+ Fibroblasts", "Ccl11+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Lef1+ Tcf7+ Cd4+ T cells", "Gpihbp1+ Fabp4+ Endothelial cells",
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Pi16Fibroblasts_specific_ligands, Mfap4Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MgpFibroblasts_specific_ligands, Cd4Tcells_specific_ligands, 
...
ligand_order = c(Pi16Fibroblasts_specific_ligands, Mfap4Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MgpFibroblasts_specific_ligands, Cd4Tcells_specific_ligands, 
                 EC_specific_ligands, Clandnonclmonocytes_specific_ligands, ConvDC1_specific_ligands, M2Macrophages_specific_ligands, InflMacrophages_specific_ligands, 
                 Pf4Macro_specific_ligands, Mesothelialcells_specific_ligands, Fscn1DC_specific_ligands, Intermonocytes_specific_ligands, NK_specific_ligands, plasmacells_specific_ligands, 
