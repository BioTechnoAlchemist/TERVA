...
receiver = "Lef1+ Tcf7+ Cd4+ T cells" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("B cells", "Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mfap4+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Gpihbp1+ Fabp4+ Endothelial cells",
