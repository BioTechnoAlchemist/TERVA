...
receiver = "Vascular smooth muscle cells" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "B cells", "Macrophages activated", "Fibroblasts", "Fibroblasts activated", "Pi16+ adventitial Fibroblasts", "Mgp+ Fibroblasts", "Granulocytes")
...
ligand_type_indication_df = tibble(
  ligand_type = c(rep("Cd8T-specific", times = Cd8T_specific_ligands %>% length()),
                  ...
                  rep("MgpFibro-specific", times = MgpFibro_specific_ligands %>% length()),
                  rep("Granu-specific", times = Granu_specific_ligands %>% length()),
                  rep("General", times = general_ligands %>% length())),
  ligand = c(Cd8T_specific_ligands, Cd4T_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Bcells_specific_ligands, Macroact_specific_ligands, Fibro_specific_ligands, Fibroact_specific_ligands, Pi16Fibro_specific_ligands, MgpFibro_specific_ligands, Granu_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycols[[1]],
                   ...
                   "Macroact-specific" = mycols[[10]],
                   "Fibro-specific" = mycols[[11]],
                   "Fibroact-specific" = mycols[[12]],
                   "Pi16Fibro-specific" = mycols[[13]],
...
ligand_order = c(Cd8T_specific_ligands, Cd4T_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Bcells_specific_ligands, Macroact_specific_ligands, Fibro_specific_ligands, Fibroact_specific_ligands, Pi16Fibro_specific_ligands, MgpFibro_specific_ligands, Granu_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
...
gaps = c(rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "ILC-specific") %>% distinct(ligand) %>% nrow() -1)),
