...
## sender
sender_celltypes = c("B cells", "Cd4+ Tcells", "Cd8+ Ccl5+ Teffs", "Cd4+ Foxp3+ Tregs", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Macrophages activated", "Vascular smooth muscle cells", "Conventional Dendritic cells 2")
