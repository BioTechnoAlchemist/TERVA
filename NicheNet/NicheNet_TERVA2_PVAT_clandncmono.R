...
receiver = "Classical and non-classical monocytes" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("B cells", "Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mfap4+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Lef1+ Tcf7+ Cd4+ T cells",
                     "Gpihbp1+ Fabp4+ Endothelial cells", "Conventional Dendritic cells DC1", "Folr2+ Lyve1+ M2 Macrophages", "Ccl4+ Cxcl2+ Ccl3+ Inflammatory Macrophages",
...
Pi16Fibroblasts_specific_ligands = sender_ligand_assignment$`Cd248+ Pi16+ Fibroblasts` %>% names() %>% setdiff(general_ligands)
Ccl11Fibroblasts_specific_ligands = sender_ligand_assignment$`Ccl11+ Fibroblasts` %>% names() %>% setdiff(general_ligands)
MfapFibroblasts_specific_ligands = sender_ligand_assignment$`Mfap4+ Fibroblasts` %>% names() %>% setdiff(general_ligands)
...
ligand_type_indication_df = tibble(
  ligand_type = c(rep("Bcell_specific_ligands", times = Bcell_specific_ligands %>% length()),
                  rep("Pi16Fibroblasts_specific_ligands", times = Pi16Fibroblasts_specific_ligands %>% length()),
                  rep("Ccl11Fibroblasts_specific_ligands", times = Ccl11Fibroblasts_specific_ligands %>% length()),
                  rep("MfapFibroblasts_specific_ligands", times = MfapFibroblasts_specific_ligands %>% length()),
  ...
  ligand = c(Bcell_specific_ligands, Pi16Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MfapFibroblasts_specific_ligands, MgpFibro_specific_ligands, 
             Cd4Tcells_specific_ligands, EC_specific_ligands, ConvDC1_specific_ligands, M2Macrophages_specific_ligands, InflMacrophages_specific_ligands, 
             Pf4Macro_specific_ligands, Mesothelialcells_specific_ligands, Fscn1DC_specific_ligands, Intermonocytes_specific_ligands, NK_specific_ligands, plasmacells_specific_ligands, 
             Granulocytes_specific_ligands, VSMC_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycolors[[1]],
                   "Bcell_specific_ligands", mycolors[[2]],
                   "Pi16Fibroblasts_specific_ligands", mycolors[[3]],
                   "Ccl11Fibroblasts_specific_ligands", mycolors[[4]],
                   "MfapFibroblasts_specific_ligands", mycolors[[5]],
                   "MgpFibro_specific_ligands", mycolors[[6]],
                   "Cd4Tcells_specific_ligands", mycolors[[7]],
                   "EC_specific_ligands", mycolors[[8]],
                   "ConvDC1_specific_ligands", mycolors[[9]],
                   "M2Macrophages_specific_ligands", mycolors[[10]],
                   "InflMacrophages_specific_ligands", mycolors[[11]],
                   "Pf4Macro_specific_ligands", mycolors[[12]],
                   "Mesothelialcells_specific_ligands", mycolors[[13]],
                   "Fscn1DC_specific_ligands", mycolors[[14]],
                   "Intermonocytes_specific_ligands", mycolors[[15]],
                   "NK_specific_ligands", mycolors[[16]],
                   "plasmacells_specific_ligands", mycolors[[17]],
                   "Granulocytes_specific_ligands", mycolors[[18]],
                   "VSMC_specific_ligands", mycolors[[19]]
)
...
ligand_order = c(Bcell_specific_ligands, Pi16Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MfapFibroblasts_specific_ligands, MgpFibro_specific_ligands, 
                 Cd4Tcells_specific_ligands, EC_specific_ligands, ConvDC1_specific_ligands, M2Macrophages_specific_ligands, InflMacrophages_specific_ligands, 
                 Pf4Macro_specific_ligands, Mesothelialcells_specific_ligands, Fscn1DC_specific_ligands, Intermonocytes_specific_ligands, NK_specific_ligands, plasmacells_specific_ligands, 
                 Granulocytes_specific_ligands, VSMC_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
