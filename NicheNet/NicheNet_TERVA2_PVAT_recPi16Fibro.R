...
receiver = "Pi16+ adventitial Fibroblasts" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Macrophages activated", "Vascular smooth muscle cells", "Fibroblasts", "Fibroblasts activated", "B cells", "Mgp+ Fibroblasts", "Granulocytes")
...
ligand_order = c(Cd8T_specific_ligands, Cd4T_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Bcells_specific_ligands, VSMC_specific_ligands, Fibro_specific_ligands, Fibroact_specific_ligands, Macroact_specific_ligands, MgpFibro_specific_ligands, Granu_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
