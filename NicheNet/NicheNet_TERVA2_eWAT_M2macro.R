...
receiver = "Folr2+ Lyve1+ M2 Macrophages" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, eWAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Mfap4+ Fibroblasts", "Ccl4+ Cxcl2+ Ccl3+ Inflammatory Macrophages", 
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, Infl_Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, EC_specific_ligands, Treg_specific_ligands, VSMC_specific_ligands, Intermono_specific_ligands, general_ligands))
...
ligand_order = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, Infl_Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, EC_specific_ligands, Treg_specific_ligands, VSMC_specific_ligands, Intermono_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
