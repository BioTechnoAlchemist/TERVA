...
receiver = "Lef1+ Tcf7+ Cd8a+ Cd8b1+ T cells" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, Spleen, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("B cells", "Lef1+ Tcf7+ Cd4+ T cells", "Cd8+ Ccl5+ Nkg7+ Cytotoxic T cells",  "Foxp3+ Regulatory T cells","s100a9+/a8+ Granulocytes")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Bcells_specific_ligands, Lef1Tcf7Cd4Tcells_specific_ligands, Cd8Ccl5Nkg7CytotoxTcells_specific_ligands, Foxp3RegTcells_specific_ligands, Granulocytes_specific_ligands, general_ligands))
...
ligand_order = c(Bcells_specific_ligands, Lef1Tcf7Cd4Tcells_specific_ligands, Cd8Ccl5Nkg7CytotoxTcells_specific_ligands, Foxp3RegTcells_specific_ligands, Granulocytes_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
