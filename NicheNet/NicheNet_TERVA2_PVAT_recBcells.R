...
receiver = "B cells" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Macrophages activated", "Vascular smooth muscle cells", "Fibroblasts", "Fibroblasts activated", "Pi16+ adventitial Fibroblasts", "Mgp+ Fibroblasts", "Granulocytes")
