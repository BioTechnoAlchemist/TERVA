...
receiver = "Mgp+ Aebp1+ Activated fibroblasts" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("B cells", "Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mfap4+ Fibroblasts", "Lef1+ Tcf7+ Cd4+ T cells", "Gpihbp1+ Fabp4+ Endothelial cells",
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Bcell_specific_ligands, Pi16Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MfapFibroblasts_specific_ligands, Cd4Tcells_specific_ligands, 
             EC_specific_ligands, Clandnonclmonocytes_specific_ligands, ConvDC1_specific_ligands, M2Macrophages_specific_ligands, InflMacrophages_specific_ligands, 
...
grid_col_ligand =c("General" = mycolors[[1]],
                   ...
                   "Cd4Tcells_specific_ligands", mycolors[[6]],
                   "EC_specific_ligands", mycolors[[7]],
                   "Clandnonclmonocytes_specific_ligands", mycolors[[8]],
...
ligand_order = c(Bcell_specific_ligands, Pi16Fibroblasts_specific_ligands, Ccl11Fibroblasts_specific_ligands, MfapFibroblasts_specific_ligands, Cd4Tcells_specific_ligands, 
                 EC_specific_ligands, Clandnonclmonocytes_specific_ligands, ConvDC1_specific_ligands, M2Macrophages_specific_ligands, InflMacrophages_specific_ligands, 
                 Pf4Macro_specific_ligands, Mesothelialcells_specific_ligands, Fscn1DC_specific_ligands, Intermonocytes_specific_ligands, NK_specific_ligands, plasmacells_specific_ligands, 
