...
receiver = "Foxp3+ Regulatory T cells"  #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, Spleen, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("B cells", "Lef1+ Tcf7+ Cd4+ T cells", "Lef1+ Tcf7+ Cd8a+ Cd8b1+ T cells",  "Cd8+ Ccl5+ Nkg7+ Cytotoxic T cells","s100a9+/a8+ Granulocytes")
...
ligand_type_indication_df = tibble(
  ligand_type = c(rep("Bcells_specific_ligands", times = Bcells_specific_ligands %>% length()),
                  rep("Lef1Tcf7Cd4Tcells_specific_ligands", times = Lef1Tcf7Cd4Tcells_specific_ligands %>% length()),
  ...
  ligand = c(Bcells_specific_ligands, Lef1Tcf7Cd4Tcells_specific_ligands, Lef1Tcf7Cd8Tcells_specific_ligands, Cd8Ccl5Nkg7CytotoxTcells_specific_ligands, Granulocytes_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycolors[[1]],
                   "Bcells_specific_ligands" = mycolors[[2]],
                   "Lef1Tcf7Cd4Tcells_specific_ligands" = mycolors[[3]],
                   "Cd8Ccl5Nkg7CytotoxTcells_specific_ligands" = mycolors[[5]],
...
ligand_order = c(Bcells_specific_ligands, Lef1Tcf7Cd4Tcells_specific_ligands, Lef1Tcf7Cd8Tcells_specific_ligands, Cd8Ccl5Nkg7CytotoxTcells_specific_ligands, Granulocytes_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
...
gaps = c(rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "Granulocytes_specific_ligands") %>% distinct(ligand) %>% nrow() -1)),
