...
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Cd8+ Ccl5+ Teffs", "Cd4+ Foxp3+ Tregs", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Macrophages activated", "Vascular smooth muscle cells", "Conventional Dendritic cells 2")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Cd8T_specific_ligands, Cd4T_specific_ligands, Teffs_specific_ligands, Tregs_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Macroact_specific_ligands, VSMC_specific_ligands, DC2_specific_ligands, general_ligands))
...
ligand_order = c(Cd8T_specific_ligands, Cd4T_specific_ligands, Teffs_specific_ligands, Tregs_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Macroact_specific_ligands, VSMC_specific_ligands, DC2_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
