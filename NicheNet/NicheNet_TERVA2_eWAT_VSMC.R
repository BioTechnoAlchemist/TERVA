...
sender_celltypes = c("Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Mfap4+ Fibroblasts", "Ccl4+ Cxcl2+ Ccl3+ Inflammatory Macrophages", "Folr2+ Lyve1+ M2 Macrophages",
                     "Trem2+ Lgals3+ Macrophages", "Mesothelial cells", "Gpihbp1+ Fabp4+ Endothelial cells", "Conventional Dendritic cells DC1", "Foxp3+ Regulatory T cells", "Intermediate monocytes")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, Infl_Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, M2Macro_specific_ligands, Treg_specific_ligands, EC_specific_ligands, Intermono_specific_ligands, general_ligands))
...
ligand_order = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, Infl_Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, M2Macro_specific_ligands, Treg_specific_ligands, EC_specific_ligands, Intermono_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
