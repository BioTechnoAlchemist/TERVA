...
receiver = "Macrophages activated" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, PVAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "B cells", "Vascular smooth muscle cells", "Fibroblasts", "Fibroblasts activated", "Pi16+ adventitial Fibroblasts", "Mgp+ Fibroblasts", "Granulocytes")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Cd8T_specific_ligands, Cd4T_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Bcells_specific_ligands, VSMC_specific_ligands, Fibro_specific_ligands, Fibroact_specific_ligands, Pi16Fibro_specific_ligands, MgpFibro_specific_ligands, Granu_specific_ligands, general_ligands))
...
gaps = c(rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "Lgals3-specific") %>% distinct(ligand) %>% nrow() -1)),
