...
receiver = "Rgs5+ EC's" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, eWAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Intermediate Monocytes", "Classical and non-classical Monocytes", "Lgals3+ Macrophages", "Macrophages", "Fibroblasts", "Endothelial cells", "Macrophages activated", "Pi16+ adventitial Fibroblasts", "Vascular smooth muscle cells")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(VSMC_specific_ligands, ECs_specific_ligands, Fibro_specific_ligands, Lgals3_specific_ligands, Mono_specific_ligands, IntMono_specific_ligands, Macroact_specific_ligands, Macro_specific_ligands, Pi16Fibro_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycols[[1]],
                   ...
                   "Lgals3-specific" = mycols[[5]],
                   "Mono-specific" = mycols[[6]],
                   "IntMono-specific" = mycols[[2]],
                   "Macroact-specific" = mycols[[8]],
...
ligand_order = c(VSMC_specific_ligands, ECs_specific_ligands, Fibro_specific_ligands, Lgals3_specific_ligands, Mono_specific_ligands, IntMono_specific_ligands, Macroact_specific_ligands, Macro_specific_ligands, Pi16Fibro_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
