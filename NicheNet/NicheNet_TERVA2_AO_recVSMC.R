...
## sender
sender_celltypes = c("Cd8+ Tcells", "Cd4+ Tcells", "Cd8+ Ccl5+ Teffs", "Cd4+ Foxp3+ Tregs", "Intermediate Monocytes", "Classical and non-classical Monocytes", "Innate lymphoid cells", "Lgals3+ Macrophages", "Macrophages", "Macrophages activated", "B cells", "Conventional Dendritic cells 2")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(Cd8T_specific_ligands, Cd4T_specific_ligands, Teffs_specific_ligands, Tregs_specific_ligands, IntMono_specific_ligands, Mono_specific_ligands, ILC_specific_ligands, Lgals3_specific_ligands, Macro_specific_ligands, Macroact_specific_ligands, Bcells_specific_ligands, DC2_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycols[[1]],
                   ...
                   "Lgals3-specific" = mycols[[9]],
                   "Macro-specific" = mycols[[10]],
                   "Macroact-specific" = mycols[[11]],
                   "Bcells-specific" = mycols[[12]],
