...
receiver = "Intermediate Monocytes" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, eWAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Macrophages activated", "Classical and non-classical Monocytes", "Lgals3+ Macrophages", "Macrophages", "Fibroblasts", "Endothelial cells", "Rgs5+ EC's", "Pi16+ adventitial Fibroblasts", "Vascular smooth muscle cells")
...
ligand_type_indication_df = tibble(
  ...
  ligand = c(VSMC_specific_ligands, ECs_specific_ligands, Fibro_specific_ligands, Lgals3_specific_ligands, Mono_specific_ligands, Macroact_specific_ligands, Rgs5ECs_specific_ligands, Macro_specific_ligands, Pi16Fibro_specific_ligands, general_ligands))
...
ligand_order = c(VSMC_specific_ligands, ECs_specific_ligands, Fibro_specific_ligands, Lgals3_specific_ligands, Mono_specific_ligands, Macroact_specific_ligands, Rgs5ECs_specific_ligands, Macro_specific_ligands, Pi16Fibro_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
