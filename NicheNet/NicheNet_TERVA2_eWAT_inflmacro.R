...
receiver = "Ccl4+ Cxcl2+ Ccl3+ Inflammatory Macrophages" #Just change this to your cell type of interest
expressed_genes_receiver = get_expressed_genes(receiver, eWAT, pct = 0.10)
background_expressed_genes = expressed_genes_receiver %>% .[. %in% rownames(ligand_target_matrix)]
## sender
sender_celltypes = c("Cd248+ Pi16+ Fibroblasts", "Ccl11+ Fibroblasts", "Mgp+ Aebp1+ Activated fibroblasts", "Mfap4+ Fibroblasts", "Folr2+ Lyve1+ M2 Macrophages", 
                     "Trem2+ Lgals3+ Macrophages", "Mesothelial cells", "Vascular smooth muscle cells", "Gpihbp1+ Fabp4+ Endothelial cells", "Conventional Dendritic cells DC1", "Foxp3+ Regulatory T cells", "Intermediate monocytes")
...
Conv_DC_specific_ligands = sender_ligand_assignment$`Conventional Dendritic cells DC1` %>% names() %>% setdiff(general_ligands)
...
ligand_type_indication_df = tibble(
  ligand_type = c(rep("Ccl11Fibro_specific_ligands", times = Ccl11Fibro_specific_ligands %>% length()),
                  ...
                  rep("Conv_DC_specific_ligands", times = Conv_DC_specific_ligands %>% length()),
  ...
  ligand = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, M2Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, EC_specific_ligands, Treg_specific_ligands, VSMC_specific_ligands, Intermono_specific_ligands, general_ligands))
...
grid_col_ligand =c("General" = mycolors[[1]],
                   ...
                   "M2Macro_specific_ligands" = mycolors[[6]],
                   "Trem2Lgals3Macro_specific_ligands" = mycolors[[7]],
                   "Conv_DC_specific_ligands" = mycolors[[8]],
                   "Mesothelial_specific_ligands" = mycolors[[9]],
                   "EC_specific_ligands" = mycolors[[10]],
                   "Treg_specific_ligands" = mycolors[[11]],
                   "VSMC_specific_ligands" = mycolors[[12]],
...
ligand_order = c(Ccl11Fibro_specific_ligands, MgpFibro_specific_ligands, MfapFibro_specific_ligands, Pi16Fibro_specific_ligands, M2Macro_specific_ligands, Trem2Lgals3Macro_specific_ligands, Conv_DC_specific_ligands, Mesothelial_specific_ligands, EC_specific_ligands, Treg_specific_ligands, VSMC_specific_ligands, Intermono_specific_ligands, general_ligands) %>% c(paste(.," ")) %>% intersect(circos_links$ligand)
...
gaps = c(rep(width_same_cell_same_ligand_type, times = (circos_links %>% filter(ligand_type == "Trem2Lgals3Macro_specific_ligands") %>% distinct(ligand) %>% nrow() -1)),
