...
sub <- subset(srat, subset = nFeature_RNA > 200 & nFeature_RNA < 5000 & percent.mt < 10) # Here we prune the data with the given thresholds to get rid of some noise.
