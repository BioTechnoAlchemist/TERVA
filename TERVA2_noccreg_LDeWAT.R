...
# Channel with 32285 genes and 8847 cells
...
#### ADD antibody data ####
tenx <- Read10X("/Users/limikk/Desktop/TERVA/TERVA2DATA/LD_AO_GEX_Ab_VDJ_noIntr_SC5PPE_actuallyLDeWAT/outs/per_sample_outs/LD_AO_GEX_Ab_VDJ_noIntr_SC5PPE/count/filtered_feature_bc_matrix/")
