...
data_up <- read.csv("upregulated results/PVAT_Fibro_Pi16_gProfiler_mmusculus_26-10-2023_13-21-24__intersections.csv", sep = ";") #This originates from a web interface run of g:profiler at https://biit.cs.ut.ee/gprofiler/gost.
data_up <- data_up %>%
...
data_down <- read.csv("downregulated results/PVAT_Pi16Fibro_gProfiler_mmusculus_16-04-2024_18-43-43__intersections.csv", sep = ";")
data_down <- data_down %>%
